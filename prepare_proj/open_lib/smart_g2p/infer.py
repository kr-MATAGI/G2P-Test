...
with open('/home/ailab/바탕화면/KT_IPA/G2P-Test/prepare_proj/open_lib/smart_g2p/symbols.txt', 'r', encoding='UTF8') as f:
...
model.load_state_dict(torch.load("/home/ailab/바탕화면/KT_IPA/G2P-Test/prepare_proj/open_lib/smart_g2p/transliteration.pt"))
model.to(device)
#model.eval()
